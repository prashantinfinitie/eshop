...
<section class="breadcrumb-title-bar colored-breadcrumb deeplink_wrapper">
    <div class="main-content responsive-breadcrumb">
        <h2><?= !empty($this->lang->line('address')) ? str_replace('\\', '', $this->lang->line('address')) : 'Address' ?></h2>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><?= !empty($this->lang->line('address')) ? str_replace('\\', '', $this->lang->line('address')) : 'Address' ?></a></li>
            </ol>
        </nav>
    </div>
                    ...
                    <form action="<?= base_url('my-account/add-address') ?>" method="POST" id="add-address-form" class="mt-4 p-4">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                ...
                                <input type="text" pattern="\d*" maxlength="16" class="form-control" id="mobile_number" name="mobile" placeholder="<?= !empty($this->lang->line('mobile_number')) ? str_replace('\\', '', $this->lang->line('mobile_number')) : 'Mobile Number' ?>" />
                            </div>
                            <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                ...
                                <input type="text" class="form-control" pattern="\d*" maxlength="16" id="alternate_mobile" name="alternate_mobile" placeholder="<?= !empty($this->lang->line('alternate_mobile')) ? str_replace('\\', '', $this->lang->line('alternate_mobile')) : 'Alternate Mobile Number' ?>" />
                            </div>
                            <div class="col-md-12 col-sm-12 col-xs-12 form-group">
