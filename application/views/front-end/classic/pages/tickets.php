...
<section class="breadcrumb-title-bar colored-breadcrumb deeplink_wrapper">
    <div class="main-content responsive-breadcrumb">
        <h2><?= !empty($this->lang->line('support_tickets')) ? str_replace('\\', '', $this->lang->line('support_tickets')) : 'Suport Tickets' ?></h2>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><?= !empty($this->lang->line('support_tickets')) ? str_replace('\\', '', $this->lang->line('support_tickets')) : 'Support Tickets' ?></li>
            </ol>
        </nav>
    </div>
...
<!-- <main class="deeplink_wrapper"> -->
    <section class="my-account-section py-5">
        <div class="row main-content">
            ...
            <div class="col-md-8 padding-16-30 home_faq">
                <div class="align-items-center d-flex flex-wrap justify-content-between pb-3">
                    <h2 class="section-tile"><span
                            class="price"><?= !empty($this->lang->line('customer_support')) ? str_replace('\\', '', $this->lang->line('customer_support')) : 'Customer Support' ?></span>
                    </h2>
                    <button type="submit" class="btn btn-primary viewmorebtn ticket_button"
                    ...
                    <form class="form-horizontal form-submit-event" id="stock_adjustment_form" method="POST"
                        ...
                        <select class="col-md-12 form-control" name="ticket_type_id">
                            <?php foreach ($ticket_types as $type) {
                                ...
                                ?>
                                <option id='ticket_type' value="<?= $type['id'] ?>" <?= $selected ?>><?= $type['title'] ?>
                                </option>
                                <?php
                            } ?>
                        </select>
                                ...
                                <div class="modal-content">
                                    <div class="modal-body">
                                        ...
                                        <form class="form-horizontal form-submit-event" id="stock_adjustment_form" method="POST"
                                            ...
                                            <input type="hidden" class="form-control " value=<?= $ticket['id'] ?> name="edit_id"
                                                id="ticket_id">
                                            <footer class="mt-4">
                                ...
                                <div class="card direct-chat direct-chat-primary">
                                    ...
                                    <div class="card-body">
                                        <div class="direct-chat-messages" id="element">
                                            <div class="ticket_msg" data-limit="<?= $limit ?>"
                                                data-offset="<?= $offset ?>" data-max-loaded="false">
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="message" id="message_input"
                                                        placeholder="Type Message ..." class="form-control p-2">
                                                </div>
                                            </div>
                                            <div class="row mt-2">
