    ...
    <div class="container-fluid ">
        <div class="card-body login-card-body">
            <div class="login-logo">
                <a href="<?= base_url() . 'shipping_company/login' ?>"><img src="<?= base_url() . $logo ?>"></a>
            </div>
            <h2 class="text-dark">Welcome Back!</h2>
            <p class="text-dark mb-4">Please login to your account</p>
            <form action="<?= base_url('shipping_company/login/auth') ?>" class='form-submit-event' method="post">
                ...
                <div class="row">
                    <div class="col-12 mb-3 text-right">
                        <a href="<?= base_url('/shipping_comapany/login/forgot_password') ?>" class="text-dark"><?= !empty($this->lang->line('forgot_password')) ? $this->lang->line('forgot_password') : 'Forgot Password' ?> ?</a>
                    </div>
