                        ...
                        <div class="row justify-content-center unselectable no-gutters">
                            <div class="navbar-nav nav__list js-nav__list col-12 col-sm-4 col-lg-3">
                                <div class="card chat-theme-light chat-scroll chat-min">
                                    <select name="select_user_id[]" id="chat_user" class="search_user w-100" data-placeholder=" Type to search and select users" onload="multiselect()">
                                        <option value=""></option>
                                        <?php
                                        $user_details = fetch_details('users', ['active' => 1]);
                                        if (!empty($user_details)) {
                                        ?>
                                            <option value="<?= $user_details[0]['id'] ?>"> <?= (isset($user_details[0]['opponent_username']) && !empty($user_details[0]['opponent_username'])) ? $user_details[0]['opponent_username'] : $user_details[0]['username'] ?></option>
                                        <?php
                                        }
