                            ...
                            ?>
                                <div class="product-image-thumb active">
                                    <a href="<?= $row ?>" class="" data-toggle="lightbox" data-gallery="product-gallery">
                                        ...
                                        <img src="<?= $row ?>" class="img-fluid rounded col-md-3"></a>
                                </div>
                            <?php
                            }
                ...
                <div class="row mt-4">
                    <nav class="w-100">
                        ...
                        <div class="nav nav-tabs" id="product-tab" role="tablist">
                            <?php if (!empty($product_details[0]['description'])) { ?><a class="nav-item nav-link active" id="product-desc-tab" data-toggle="tab" href="#product-desc" role="tab" aria-controls="product-desc" aria-selected="true">Description</a><?php } ?>
                            <?php if (!empty($product_rating['product_rating'])) { ?> <a class="nav-item nav-link <?= $rating_active ?>" id="product-rating-tab" data-toggle="tab" href="#product-rating" role="tab" aria-controls="product-rating" aria-selected="false">Rating</a><?php } ?>
                            </dv>
                    </nav>
