                    ...
                    <div class="card content-area p-4">
                        <div class="card-header border-0">
                            <div class="card-tools">
                                <a href="<?= base_url() . 'seller/product_faqs/create_product_faqs' ?>" class="btn btn-block btn-outline-primary btn-sm">Add Product FAQs</a>
                            </div>
                        </div>
                        <div class="card-innr">
                            ...
                            "ignoreColumn": ["state"] 
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th data-field="question" data-sortable="false" data-formatter="itemsReadMoreFormatter">Question</th>
                                        <th data-field="answer" data-sortable="false" data-formatter="itemsReadMoreFormatter">Answer</th>
