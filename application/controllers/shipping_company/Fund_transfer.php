...
class Fund_transfer extends CI_Controller
{
    ...
    public function index()
    {
        if ($this->ion_auth->logged_in() && $this->ion_auth->is_shipping_company()) {
            ...
            redirect('shipping_company/login', 'refresh');
        }
    }
    ...
    public function get_deliveryboy_transactions()
    {
        if ($this->ion_auth->logged_in() && $this->ion_auth->is_delivery_boy()) {
            return $this->Delivery_boy_model->get_deliveryboy_transactions($this->ion_auth->user()->row()->id);
        } else {
            redirect('delivery_boy/login', 'refresh');
        }
    }
