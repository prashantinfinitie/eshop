        ...
        success: function (result) {
            ...
            $('input[type=radio][name=payment_method]').change(function () {
                ...
                if (selectedPaymentMethod === 'COD') {
                    ...
                    // Ensure it's a string; if it's null or undefined, default to an empty string
                    delivery_charge_with_cod = (delivery_charge_with_cod != null) ? String(delivery_charge_with_cod) : '';

                    // Check if the comma exists and replace it if necessary
                    var delivery_charge = delivery_charge_with_cod.indexOf(',') !== -1 ?
                        delivery_charge_with_cod.replace(/,/g, '') :
                    ...
                    // Ensure it's a string; if it's null or undefined, default to an empty string
                    delivery_charge_without_cod = (delivery_charge_without_cod != null) ? String(delivery_charge_without_cod) : '';

                    // Check if the comma exists and replace it if necessary
                    var delivery_charge = delivery_charge_without_cod.indexOf(',') !== -1 ?
                        delivery_charge_without_cod.replace(/,/g, '') :
